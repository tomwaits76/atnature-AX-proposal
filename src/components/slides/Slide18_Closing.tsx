...
export default function Slide18_Closing() {
    return (
        <div className="w-[1920px] h-[1080px] bg-sage-800 flex flex-col items-center justify-between p-20 relative text-white text-center">
