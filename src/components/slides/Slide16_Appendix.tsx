...
export default function Slide16_Appendix() {
    const materials = [
        ...
        { title: "AI 컨설턴트의 전략 심층 보고서", link: "https://gemini.google.com/share/4fef8b8119d6", highlight: false },
        { title: "AI 컨설턴트의 전략 브리핑 페이지", link: "https://gemini.google.com/share/8e78e195aaae", highlight: false }
    ];
                    ...
                    {materials.map((item, i) => (
                        ...
                        >
                            ...
                            >
                                ...
                                <div className="p-3 rounded-full bg-sage-50 text-sage-400 group-hover:text-white group-hover:bg-sage-600 transition-all">
