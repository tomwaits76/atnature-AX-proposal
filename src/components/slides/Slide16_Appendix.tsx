...
export default function Slide16_Appendix() {
    const materials = [
        ...
        { title: "앳네이처 전략 심층 보고서 : AI 제작", link: "https://gemini.google.com/share/4fef8b8119d6", highlight: false },
        { title: "앳네이처 전략 요약 페이지 : AI 제작", link: "https://gemini.google.com/share/8e78e195aaae", highlight: false }
    ];
